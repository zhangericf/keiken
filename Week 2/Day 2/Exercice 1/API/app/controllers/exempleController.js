const Library = require("../models/exempleModel.js");
...
exports.create = (req, res) => {
  ...
  Library.create(tutorial, (err, data) => {
    if (err)
      res.status(500).send({
        message:
...
exports.findAllPublished = (req, res) => {
  Library.getAllPublished((err, data) => {
    if (err)
      res.status(500).send({
        message:
          err.message || "Some error occurred while retrieving tutorials.",
